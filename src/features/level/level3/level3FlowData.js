...
export const virusTheorySlides = [
  ...
  },
  {
    ...
    detectTitle: 'Как заметить:',
    detect: ['файлы не открываются', 'появляется требование оплаты', 'устройство заблокировано'],
    protectTitle: 'Как защититься:',
    protect: [
  ...
  },
  {
    ...
    protect: [
      ...
      'не открывать вложение электронной почты и не запускать программу, если вы не уверены в её безопасности',
    ],
...
export const level3Flow = [
  {
    ...
    bgKey: 'scene1',
    character: 'Ваня',
    text: '— О, я наконец-то нашёл игру, в которую сейчас все друзья играют! Сейчас скачаю!',
  },
  { type: 'scene2popups' },
  {
    type: 'dialogue',
    bgKey: 'scene3',
    character: 'Луно',
    text: ['— Похоже, на устройство попала вредоносная программа.', '— Такие программы называются вирусами.'],
  },
  { type: 'theory' },
  {
    type: 'dialogue',
